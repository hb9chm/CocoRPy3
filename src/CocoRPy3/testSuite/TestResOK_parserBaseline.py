...
class Parser( object ):
   ...
   def Test( self ):
      if self.la.kind == 1:
         ...
         self.G()
         self.H()
      elif self.la.kind == 0 or self.la.kind == 2 or self.la.kind == 3:
         self.I()
      else:
         self.SynErr(6)
   ...
   def E( self ):
      if self.la.kind == 1:
         self.Get( )
      elif self.la.kind == 3 or self.la.kind == 4:
         if (self.la.kind == 3):
            if true:
               self.Get( )
            else:
      ...
      while self.StartOf(1):
         if true:
            if (self.la.kind == 1):
               self.Get( )
            self.Expect(2)
         elif self.la.kind == 4 or self.la.kind == 5:
            self.Get()
         else:
            self.Get( )
   ...
   def I( self ):
      if aaa:
         if (self.la.kind == 2):
            self.Get( )
      elif self.la.kind == 0 or self.la.kind == 3:
