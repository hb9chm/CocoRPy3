...
class Parser( object ):
   ...
   def Test( self ):
      ...
      while not (self.StartOf(1)):
         self.SynErr(11)
         self.Get()
      while self.la.kind == 2 or self.la.kind == 3:
         if self.la.kind == 2:
            self.Get( )
         else:
            self.Get( )
   ...
   def A( self ):
      while not (self.la.kind == 0 or self.la.kind == 5 or self.la.kind == 7):
         self.SynErr(12)
         self.Get()
      if (self.la.kind == 5):
         self.Get( )
   ...
   errorMessages = {
      ...
      9 : "i expected",
      10 : "??? expected",
      11 : "this symbol not expected in Test",
      12 : "this symbol not expected in A",
      }
